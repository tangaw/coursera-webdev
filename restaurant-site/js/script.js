//* $ is a jQuery syntax object
$(function () { // Same as document.addEventListener("DOMContentLoaded")..

  // Same as document.querySelector("#navbarToggle").addEventListener("blur",)..
  $("#my-toggler").blur(function () {
...
(function (global) {
  ...
  let switchMenuToActive = function () {
    ...
    classes = classes.replace(new RegExp("table-acitve", "g"), "");
  ...
  // Using categories data and snippets html to build categories view HTML to be inserted into page
  ...
  function buildMenuItemsViewHtml(
    ...
    for (let i = 0; i < menuItems.length; i++) {
      ...
      if (i % 2 != 0) {
        html += "<div class='clearfix d-none d-md-block'></div>"
      }
  ...
  // Prepends price with '$' if price exists
